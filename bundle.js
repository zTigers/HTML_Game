...
var Carrot = function () {
  ...
  _createClass(Carrot, [{
    ...
    value: function move(delta, i) {
      this.body.x -= delta * enemyspeed; //handles speed of the carrot.
      this.hitBox.x = this.body.x;
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var manifest = [{ src: "sounds/jump.ogg", id: "jump" }, { src: "sounds/music.ogg", id: "music" }, { src: "images/1.jpg", id: "bg" }, { src: "images/spaceship.gif", id: "grass" }, { src: "images/spaceship.gif", id: "bush" }, { src: "images/ground.png", id: "ground" }, { src: "images/cereal.png", id: "cereal" }, { src: "images/enemy.png", id: "carrot" }, { src: "images/rabbit.png", id: "rabbit" }];
